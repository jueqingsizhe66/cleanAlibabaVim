...
call mmtemplates#config#Add ( 'bash', '~/.vim_runtime/Templates/bash.templates', 'example', 'nte' )
...
"call mmtemplates#config#Add ( 'python', '~/.vim_runtime/Templates/python.templates', 'example', 'nte' )
